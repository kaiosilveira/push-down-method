...
- Update the repo's homepage on GitHub with:
  ...
  - The following labels: javascript, refactoring, push-down-method-refactoring
...
```bash
yarn tools:cli generate-cmt-table -r push-down-method-refactoring
```
...
| Commit SHA                                                                  | Message                  |
| --------------------------------------------------------------------------- | ------------------------ |
| [cmt-sha-1](https://github.com/kaiosilveira/push-down-method-refactoring/commit-SHA-1) | description of commit #1 |
| [cmt-sha-2](https://github.com/kaiosilveira/push-down-method-refactoring/commit-SHA-2) | description of commit #2 |
| [cmt-sha-n](https://github.com/kaiosilveira/push-down-method-refactoring/commit-SHA-n) | description of commit #n |
